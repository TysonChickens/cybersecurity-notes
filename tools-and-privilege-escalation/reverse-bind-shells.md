...
[Meterpreter shells are Metasploit's own brand of fully-featured shell](reverse-bind-shells.md#meterpreter). They are completely stable, making them very good when working with Windows targets.

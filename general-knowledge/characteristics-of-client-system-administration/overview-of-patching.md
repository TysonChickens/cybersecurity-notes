...
Patch : A set of changes to a computer program or its supporting data designed to update, fix, or improve it. This includes fixing security vulnerabilities and other bugs, with such patches usually being called _bugfixes_ or _bug fixes_, and improving the functionality, usability or performance.
